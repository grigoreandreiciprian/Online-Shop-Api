...
``;
userRouter.route("/").get(authentification_1.default, costumerControler_1.getAll, errorHandler_1.default);
userRouter.route("/").post(costumerControler_1.addUser, errorHandler_1.default);
userRouter.route("/:id").put(authentification_1.default, costumerControler_1.updateUser, errorHandler_1.default);
userRouter.route("/:id").delete(authentification_1.default, costumerControler_1.deleteUser, errorHandler_1.default);
userRouter.route("/log").post(authentification_1.default, costumerControler_1.logIn, errorHandler_1.default);
